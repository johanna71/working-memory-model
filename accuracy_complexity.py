...
image_11=extract_features('images/test/test4/circle_blue.jpg')
image_12=extract_features('images/test/test4/circle_green.jpg')
image_13=extract_features('images/test/test4/circle_red.jpg')
image_14=extract_features('images/test/test4/circle_white.jpg')
image_15=extract_features('images/test/test4/circle_yellow.jpg')
image_21=extract_features('images/test/test4/rectangle_blue.jpg')
image_22=extract_features('images/test/test4/rectangle_green.jpg')
image_23=extract_features('images/test/test4/rectangle_red.jpg')
image_24=extract_features('images/test/test4/rectangle_white.jpg')
image_25=extract_features('images/test/test4/rectangle_yellow.jpg')
image_31=extract_features('images/test/test4/star_blue.jpg')
image_32=extract_features('images/test/test4/star_green.jpg')
image_33=extract_features('images/test/test4/star_red.jpg')
image_34=extract_features('images/test/test4/star_white.jpg')
image_35=extract_features('images/test/test4/star_yellow.jpg')
image_41=extract_features('images/test/test4/triangle_blue.jpg')
image_42=extract_features('images/test/test4/triangle_green.jpg')
image_43=extract_features('images/test/test4/triangle_red.jpg')
image_44=extract_features('images/test/test4/triangle_white.jpg')
image_45=extract_features('images/test/test4/triangle_yellow.jpg')
...
image_11_=extract_features('images/test/test4/circle_blue_cue.jpg')
image_12_=extract_features('images/test/test4/circle_green_cue.jpg')
image_13_=extract_features('images/test/test4/circle_red_cue.jpg')
image_14_=extract_features('images/test/test4/circle_white_cue.jpg')
image_15_=extract_features('images/test/test4/circle_yellow_cue.jpg')
image_21_=extract_features('images/test/test4/rectangle_blue_cue.jpg')
image_22_=extract_features('images/test/test4/rectangle_green_cue.jpg')
image_23_=extract_features('images/test/test4/rectangle_red_cue.jpg')
image_24_=extract_features('images/test/test4/rectangle_white_cue.jpg')
image_25_=extract_features('images/test/test4/rectangle_yellow_cue.jpg')
image_31_=extract_features('images/test/test4/star_blue_cue.jpg')
image_32_=extract_features('images/test/test4/star_green_cue.jpg')
image_33_=extract_features('images/test/test4/star_red_cue.jpg')
image_34_=extract_features('images/test/test4/star_white_cue.jpg')
image_35_=extract_features('images/test/test4/star_yellow_cue.jpg')
image_41_=extract_features('images/test/test4/triangle_blue_cue.jpg')
image_42_=extract_features('images/test/test4/triangle_green_cue.jpg')
image_43_=extract_features('images/test/test4/triangle_red_cue.jpg')
image_44_=extract_features('images/test/test4/triangle_white_cue.jpg')
image_45_=extract_features('images/test/test4/triangle_yellow_cue.jpg')
...
# before: setup_model(0,1,2,3,4)
# new: setup_model_new([0,1,2,3], 4)
...
def display_accuracy(accuracy,accuracy_complex,error,error_complex):
    ...
    plt.errorbar(x, accuracy,
             yerr = error,
             fmt ='o',label='low complexity')
    plt.errorbar(x, accuracy_complex,
             yerr = error_complex,
             fmt ='o',label='high complexity')
    plt.xlim([0,5])
    plt.ylim([0,1])     
    plt.legend()    
    plt.show()         
